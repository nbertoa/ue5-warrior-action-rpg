...
namespace WarriorRPGTags::Enemy::Ability
{
    ...
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(SummonEnemies,
                                   ...
                                   "Identity tag for the enemy summon ability — used for " "blocking, cancellation, and cooldown queries in GAS.");
}
...
namespace WarriorRPGTags::Enemy::Event
{
    ...
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(SummonEnemies,
                                   ...
                                   "Gameplay Event sent to trigger the enemy summon sequence " "at the correct animation frame.");
}
...
namespace WarriorRPGTags::Enemy::Status
{
    ...
    UE_DEFINE_GAMEPLAY_TAG_COMMENT(Unblockable,
                                   ...
                                   "Status tag set on an enemy pawn while its current attack ignores " "the player's block state — checked by UEnemyCombatComponent::OnHitTargetActor.");
}
