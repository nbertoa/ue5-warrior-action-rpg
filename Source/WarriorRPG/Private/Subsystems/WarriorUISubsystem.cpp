...
void UWarriorUISubsystem::RegisterPrimaryLayoutWidget(UWarriorPrimaryLayout* InWidget)
{
	...
	UE_LOG(LogWarriorRPG,
	       Log,
	       TEXT("UWarriorUISubsystem::RegisterPrimaryLayoutWidget — "
		       "Primary layout widget [%s] registered successfully."),
	       *InWidget->GetName());
}
                                                                  ...
                                                                  TSubclassOf<UWarriorActivatableWidget> InWidgetClass)
{
	...
	checkf(PrimaryLayoutWidget,
	       TEXT("UWarriorUISubsystem::PushWidgetToStack — " "PrimaryLayoutWidget is null. "
		       "Ensure RegisterPrimaryLayoutWidget is called at game startup."));
	...
	checkf(NewWidget,
	       TEXT("UWarriorUISubsystem::PushWidgetToStack — " "AddWidget returned null for class [%s]. "
