...
bool UHeroGameplayAbility_TargetLock::IsTargetActorOrHeroDead()
{
    ...
    return UWarriorFunctionLibrary::NativeDoesActorHaveTag(CurrentLockedActor,
                                                           DeadStatusTag) || UWarriorFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(),
                                                                                                                             DeadStatusTag);
}
...
void UHeroGameplayAbility_TargetLock::SwitchTarget(const FGameplayTag& InSwitchDirectionTag)
{
    ...
    const TArray<AActor*>& Candidates = bSwitchLeft ? ActorsOnLeft : ActorsOnRight;
...
void UHeroGameplayAbility_TargetLock::UpdateAvailableActorsToLock()
{
    ...
    const EDrawDebugTrace::Type DrawDebugTraceType = bDebugMode ? EDrawDebugTrace::Persistent : EDrawDebugTrace::None;
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
    ...
    checkf(TargetLockWidgetClass,
           TEXT("UHeroGameplayAbility_TargetLock::DrawTargetLockWidget — " "TargetLockWidgetClass is null. " "Assign a valid widget class in the ability's Blueprint defaults."));
