...
AWarriorHeroCharacter* UWarriorHeroGameplayAbility::GetHeroCharacterFromActorInfo()
{
	...
	if (!CachedWarriorHeroCharacter.IsValid())
	{
		...
		checkf(CachedWarriorHeroCharacter.IsValid(),
		       TEXT("UWarriorHeroGameplayAbility::GetHeroCharacterFromActorInfo — "
			       "AvatarActor is not a valid AWarriorHeroCharacter. "
			       "Verify this ability is only granted to hero characters."));
	}
...
AWarriorHeroController* UWarriorHeroGameplayAbility::GetHeroControllerFromActorInfo()
{
	...
	if (!CachedWarriorHeroController.IsValid())
	{
		...
		checkf(CachedWarriorHeroController.IsValid(),
		       TEXT("UWarriorHeroGameplayAbility::GetHeroControllerFromActorInfo — "
			       "PlayerController is not a valid AWarriorHeroController. "
			       "Verify the game mode assigns AWarriorHeroController as the player controller class."));
	}
...
UHeroCombatComponent* UWarriorHeroGameplayAbility::GetHeroCombatComponentFromActorInfo()
{
	...
	if (!ensureMsgf(HeroCharacter,
	                TEXT("UWarriorHeroGameplayAbility::GetHeroCombatComponentFromActorInfo — "
		                "HeroCharacter is null. Cannot retrieve combat component.")))
	{
		return nullptr;
	}
