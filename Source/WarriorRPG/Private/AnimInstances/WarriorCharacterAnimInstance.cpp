...
void UWarriorCharacterAnimInstance::NativeInitializeAnimation()
{
    ...
    else
    {
        ...
        UE_LOG(LogWarriorRPG,
               Warning,
               TEXT("UWarriorCharacterAnimInstance::NativeInitializeAnimation — " "OwningCharacter is null. Animation data will not update. " "This is expected in animation preview mode."));
    }
}
